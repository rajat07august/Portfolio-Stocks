...
Aurionpro Solutions is a **diversified enterprise technology company** — not a single-vertical IT services firm — with 4 distinct business lines: **Banking software** (core banking + AI-native trade finance + workflow automation), **Transit technology** (traffic management, tolling, smart mobility), **Data Center infrastructure** (hyperscaler + AI-focused deployments), and **AI software** (Aurion AI native platforms, foundation models for banking). The company is going through a strategic transformation from a traditional BFSI software vendor into an **AI-native enterprise technology platform** — with FY26 marking heavy investment in Software 2.0 (agentic architecture) products.

The 30-second business snapshot:
- **HQ Mumbai** — Group CEO & Vice-Chairman: Ashish Rai (execution + AI strategy lead)
- **CFO**: Vipul Parmar
- **FY26 revenue INR 1,411 cr (+20.2% YoY)** — missed 30% growth plan (planned pre-Middle East)
- **FY26 EBITDA margin 20.02%** (within guided 20-21% band, lower end)
- **FY26 PAT margin 15.02%** (within guided 15-16% band, lower end)
- **Order book: INR 1,800+ cr** entering FY27
- **Four business verticals**:
  - **Banking** (core banking + Aurion AI native trade finance platform launched)
  - **Transit** (India strong, going global)
  - **Data Center** (won largest Indian AI-focused data center mandate from hyperscaler)
  - **AI Software** (Arya + Lexsi Labs foundation models tuned for banking)
- **Software 2.0 build-out**: Entire Aurionpro stack being rebuilt for agentic architecture over 2 quarters
- **Vision 2030** long-term positioning

**Big picture in one sentence:** Aurionpro is a **diversified BFSI + Transit + Data Center + AI enterprise tech firm** in a **strategic transformation year** — FY26 delivered 20.2% growth (below 30% plan due to Middle East war impact + hyperscaler execution delay), but heavy AI Software 2.0 investment underway with order book INR 1,800+ cr entering FY27. **High-conviction transformation play at 22.3x P/E with clear FY27 catalyst.**

---

## 2. Why This Industry Exists

Aurionpro plays across 4 verticals — each with distinct forces:

**Force 1 — Banking AI transformation.** Global banks moving from traditional workflow software to agentic AI systems. Trade finance + KYC + AML + treasury — all being reimagined for AI-native architecture.

**Force 2 — India + global transit tech.** Traffic management + tolling + smart mobility becoming mission-critical for smart cities.

**Force 3 — AI infrastructure buildout (data centers).** Hyperscalers (Google, AWS, Microsoft) + India-domestic AI compute all needing data center design + engineering.

**Force 4 — Middle East BFSI capex (cyclically challenging).** Middle East banks were a growth engine for Aurionpro; currently disrupted by geopolitics.

**Where Aurionpro sits.** Mid-cap diversified enterprise tech. Peers: Persistent Systems (larger, similar diversified), Coforge, LTIMindtree, Tata Elxsi, Cyient (adjacent). Aurionpro's differentiator: **four-vertical spread + AI Software 2.0 native build**.

---

## 3. What Makes This Company Different

**Moat 1 — 4-vertical diversification (Banking + Transit + Data Center + AI Software).**
**Moat 2 — Aurion AI native trade finance platform** — first fully agentic software launched (Software 2.0).
**Moat 3 — Largest Indian AI-focused data center mandate from hyperscaler.** Partner-of-choice for hyperscalers.
**Moat 4 — Foundation models tuned for banking (Arya + Lexsi Labs).** Proprietary IP.
**Moat 5 — Multiple strategic BFSI go-lives in FY26 across international markets.** Reference customer base.
**Moat 6 — Order book INR 1,800+ cr.** Multi-year visibility.
**Moat 7 — Transit global expansion.** India strength → international scaling.
**Moat 8 — FII rose from 2.90% to 16.29%** — sustained institutional accumulation.
**Moat 9 — Ashish Rai leadership (CEO + Vice-Chairman leading AI transformation personally).**
**Moat 10 — Software 2.0 vision** — company-wide AI-native product refresh underway.

**Where the moat is weaker.**
- FY26 growth missed 30% plan (delivered 20.2%).
- Heavy investment cycle depressing margins (EBITDA 20.02% vs peak 21%+).
- Middle East drag persistent (Q1FY27 impact expected).
- Working capital heavy for large data center projects.
- Intangibles under development jumped from INR 20-30 cr to INR 200+ cr — high investment intensity.
- 4.31% promoter dilution over 3 years (31.19% → 26.88%).
- Public 55.58% — very high retail exposure.

---

## 3.5. Management Track Record & Promoter Background

**Group CEO & Vice-Chairman:** *Mr. Ashish Rai* — leading company transformation + AI strategy personally. On concalls: candid, admits FY26 miss, articulate on AI Software 2.0 vision.

**Chief Financial Officer:** *Mr. Vipul Parmar*.

**Company Secretary:** *Mr. Ninad Kelkar*.

**Promoter — Amit Sheth family + others.** Historical Aurionpro founders.

**Promoter holding (Mar 2026): 26.88% — down from 31.19% (Jun 2023):**
...
| Mar 2026 | 26.88% (stable since Jun 2024) |

**~4.31% dilution in 2024, then stable.** Bear reading: promoter below 30% is a concern. Bull reading: FII stepped in from 2.90% to 16.29% (13.4 ppt increase) — strong institutional validation.

**Retail base:** 50,976 shareholders (up from 12,023 in Jun 2023) — 4x growth.

**Other listed entities:** None significant.

**Delivery track record:**

| Guidance / Milestone | When | Actual delivered | Verdict |
|---|---|---|---|
| **FY26 growth 30% plan** | Q1FY26 | Delivered 20.2% (missed) | 🔴 Missed |
| FY26 EBITDA margin 20-21% | Multi-quarter | 20.02% (lower end) | ✅ Delivered (barely) |
| FY26 PAT margin 15-16% | Multi-quarter | 15.02% (lower end) | ✅ Delivered (barely) |
| Aurion AI native trade finance platform | FY26 | Launched (agentic architecture) | ✅ Delivered |
| Multiple strategic BFSI go-lives | FY26 | Delivered — public sector banks + international | ✅ Delivered |
| Data center hyperscaler mandate | FY26 | Won largest India AI-focused mandate | ✅ Delivered |
...
| **FY27 Software 2.0 stack rollout** | Q4FY26 | 2 quarters of accelerated development | 🕐 Pending |
...
|---|---|---|---|
| Revenue (INR cr) | ~1,174 | 1,411 | +20.2% |
| EBITDA margin | 21%+ | 20.02% | −100+ bps |
| PAT margin | 16%+ | 15.02% | −100+ bps |
| PAT (INR cr) | ~187 | ~212 | +13% |

**Note:** FY26 growth of 20.2% is below management's 30% plan due to:
- Middle East war impact (biggest factor)
- Hyperscaler win execution delay
- Labor code implementation one-time hit
- Heavy AI + Data Center investment intensity

**Q4FY26 impact:**
- Middle East BFSI deal slippage
- Hyperscaler revenue moved from Q4 to Q1FY27
- Labor code one-time charge

**Balance sheet:**
- Book value per share: INR 314 → P/B 2.8x
- Working capital rising with large data center projects
- Intangibles under development: INR 200+ cr (up from INR 20-30 cr)
- Debt: elevated during investment cycle
...
**FY27 order book & outlook:**
- Order book entering FY27: **INR 1,800+ cr**
- Middle East recovery expected as geopolitics normalize
- Diversifying into Europe + Southeast Asia
- Software 2.0 stack rollout accelerating
- Growth target: "ahead of industry" (refused specific number)
- Margins: not planning significant dip despite investment cycle

---

## 5. Connecting the Dots

**Thread A — Aurion AI Software 2.0 transformation.** Central strategic bet.
**Thread B — Banking AI native platform (trade finance launched, more coming).**
**Thread C — Data center hyperscaler partnership.** AI infrastructure play.
**Thread D — Transit going global.**
**Thread E — Middle East recovery (temporary drag).**
**Thread F — Europe + Southeast Asia geographic expansion.**
**Thread G — Arya + Lexsi Labs foundation models.** Proprietary IP.
**Thread H — Order book INR 1,800+ cr FY27 visibility.**
...
> **Aurionpro is Virat Kohli mid-transformation phase (2019-2020) — proven skill, going through a rebuilding technique, momentum interrupted.** Diversified BFSI + Transit + Data Center + AI enterprise tech at INR 1,411 cr (FY26 +20.2%, missed 30% plan due to Middle East + hyperscaler execution delay). Aurion AI native trade finance platform launched (Software 2.0 vision), largest India AI-focused data center mandate from hyperscaler, foundation models via Arya + Lexsi Labs.
>
> The captain (Ashish Rai, CEO + Vice-Chairman leading AI transformation personally) admitted FY26 miss + reset expectations. Order book INR 1,800+ cr entering FY27.
>
> **What you're buying:** a diversified enterprise tech transformation with AI Software 2.0 stack rollout underway, largest India AI data center mandate, and BFSI global expansion — at 22.3x P/E on 16.3% ROCE. **What you're risking:** Middle East drag continues into FY27, Software 2.0 delays, margin compression from investment cycle, or additional promoter dilution. Weighted 2-year return ~35%.
>
> **What to watch:** Q1FY27 Middle East recovery signal, Software 2.0 product launches over next 2 quarters, data center hyperscaler execution ramp, and any Europe/Southeast Asia deal wins. Position sizing: **medium-high conviction on the AI transformation catalyst.**
